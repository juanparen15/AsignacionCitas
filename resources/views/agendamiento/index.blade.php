...
<div x-data="agendamientoApp()" class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4">
    <div class="max-w-5xl mx-auto">
            ...
            <div class="hidden md:flex items-center justify-between">
                <div class="flex items-center flex-1">
                    ...
                    <div class="flex items-center">
                        <div 
                            class="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-medium transition-all duration-300 shadow-md"
                        ...
                        <span class="ml-3 text-sm font-medium transition-colors" :class="step >= 1 ? 'text-gray-900' : 'text-gray-500'">
                            Seleccionar Trámite
                        </span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium transition-colors" :class="step >= 2 ? 'text-gray-900' : 'text-gray-500'">
                            Fecha y Hora
                        </span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium transition-colors" :class="step >= 3 ? 'text-gray-900' : 'text-gray-500'">
                            Datos Personales
                        </span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 text-sm font-medium transition-colors" :class="step >= 4 ? 'text-gray-900' : 'text-gray-500'">
                            Confirmación
                        </span>
                    </div>
                </div>
            ...
            <div class="md:hidden">
                <div class="flex items-center justify-center mb-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <div 
                            class="w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold bg-blue-600"
                            x-text="step"
                        ></div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="p-6 md:p-8">
                <div class="text-center mb-8">
                ...
                <div class="space-y-4 max-w-4xl mx-auto">
                    <template x-for="secretaria in secretarias" :key="secretaria.id">
                        <div class="border-2 border-gray-100 rounded-xl overflow-hidden hover:border-blue-200 transition-all duration-200 hover:shadow-md">
                            <button 
                            ...
                            >
                                <div class="flex items-center">
                                    ...
                                    <span class="font-semibold text-gray-800 text-left" x-text="secretaria.nombre"></span>
                                </div>
                                <i 
                                    class="fas fa-chevron-down transition-transform duration-200 text-blue-600"
                                ...
                                <template x-for="area in secretaria.areas_activas" :key="area.id">
                                    <div class="border-b border-gray-100 last:border-b-0">
                                        ...
                                        >
                                            ...
                                            <i 
                                                class="fas fa-chevron-down transition-transform duration-150 text-green-600"
                                            ...
                                            <template x-for="tramite in area.tramites_activos" :key="tramite.id">
                                                ...
                                                >
                                                    <div class="flex items-center justify-between">
                                                        <div class="flex-1">
                                                            <div class="flex items-center">
                                                                <div class="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center mr-3 group-hover:bg-purple-200 transition-colors">
                                                                    <i class="fas fa-file-alt text-purple-600 text-sm"></i>
                                                                </div>
                                                                <h4 class="font-semibold text-gray-800 group-hover:text-blue-700 transition-colors" x-text="tramite.nombre"></h4>
                                                            </div>
                                                            <p class="text-sm text-gray-600 mt-2 ml-11" x-text="tramite.descripcion"></p>
                                                            <div class="flex items-center mt-3 ml-11 space-x-4 flex-wrap gap-2">
                                                                <span 
                                                        ...
                                                        <i class="fas fa-arrow-right text-blue-600 opacity-0 group-hover:opacity-100 transition-all duration-200 ml-4"></i>
                                                    </div>
                                                </button>
                                            </template>
                                        </div>
            ...
            <div x-show="step === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="p-6 md:p-8">
                <div class="text-center mb-8">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-8 border border-blue-100">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center space-x-4 mt-3">
                                <span 
                                    class="text-sm px-3 py-1 rounded-full font-medium"
                                    :class="tramiteSeleccionado?.es_gratuito ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'"
                                    x-text="tramiteSeleccionado?.es_gratuito ? 'Gratuito' : '$' + new Intl.NumberFormat('es-CO').format(tramiteSeleccionado?.costo)"
                                ></span>
                    ...
                    <div class="grid lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-sm text-gray-500 bg-gray-50 p-3 rounded-lg">
                                ...
                                Disponible desde <strong x-text="fechaMinima"></strong> hasta <strong x-text="fechaMaxima"></strong>
                            </p>
                        </div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center">
                                                <div class="w-3 h-3 rounded-full mr-3"
                                                     :class="horaSeleccionada === hora.hora ? 'bg-blue-500' : 'bg-gray-300'"></div>
                                                <span class="font-semibold text-lg" x-text="hora.hora"></span>
                                            </div>
                                            <div class="text-right">
                                                <span class="text-sm font-medium" 
                                                      :class="horaSeleccionada === hora.hora ? 'text-blue-600' : 'text-gray-500'">
                                                ...
                                                <div class="w-16 h-2 bg-gray-200 rounded-full mt-1">
                                                    <div class="h-full bg-green-400 rounded-full transition-all duration-300"
                                                         :style="{ width: (hora.disponibles / hora.total) * 100 + '%' }"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                                </template>
                                <div x-show="horasDisponibles.length === 0 && fechaSeleccionada" class="text-center py-12 text-gray-500">
            ...
            <div x-show="step === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="p-6 md:p-8">
                <div class="text-center mb-8">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <form @submit.prevent="agendarCita()" class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-100 rounded-xl p-6 mb-8">
                        <div class="flex items-start">
                            ...
                            <label for="tratamiento_datos" class="text-sm text-gray-700 flex-1">
                                <span class="font-semibold text-blue-800">Acepto el tratamiento de mis datos personales</span> <span class="text-red-500">*</span>
                                <br>
            ...
            <!-- Step 4: Confirmación -->
            <div x-show="step === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0" class="p-6 md:p-8">
                <div class="text-center max-w-3xl mx-auto">
                    <div class="mb-8">
                        ...
                        <p class="text-lg text-gray-600">Su cita ha sido confirmada. Guarde la información para futuras consultas.</p>
                    </div>
                    
                    <!-- Información de la Cita -->
                    <div class="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-200 rounded-2xl p-8 mb-8 shadow-lg">
                        <div class="grid gap-4 text-left">
                            <div class="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center py-3 border-b border-green-200 last:border-b-0">
                                <span class="font-semibold text-gray-700 mb-2 sm:mb-0">Número de Cita:</span>
                                <span class="font-bold text-xl text-green-700 bg-white px-4 py-2 rounded-lg shadow-sm" x-text="citaCreada?.numero_cita"></span>
                            </div>
                            <div class="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center py-3 border-b border-green-200 last:border-b-0">
                                <span class="font-semibold text-gray-700 mb-2 sm:mb-0">Ciudadano:</span>
                                <span class="text-gray-800 font-medium" x-text="citaCreada?.nombres + ' ' + citaCreada?.apellidos"></span>
                            </div>
                            <div class="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center py-3 border-b border-green-200 last:border-b-0">
                                <span class="font-semibold text-gray-700 mb-2 sm:mb-0">Trámite:</span>
                                <span class="text-gray-800 font-medium text-right" x-text="citaCreada?.tramite?.nombre"></span>
                            </div>
                            <div class="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center py-3 border-b border-green-200 last:border-b-0">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-left">
                                ...
                                <ul class="text-sm text-yellow-700 space-y-2">
                                    ...
                                    <li>• <strong>Llegue 15 minutos antes</strong> de su cita con los documentos requeridos</li>
                                    <li>• Si no puede asistir, <strong>comuníquese con anticipación</strong> para reprogramar</li>
                                    <li>• La cita se cancelará automáticamente si llega <strong>más de 15 minutos tarde</strong></li>
                                </ul>
                            </div>
                        </div>
                    </div>
